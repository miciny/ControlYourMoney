...
class MyBottomMenuView: UIView{
    ...
    func showBottomMenu(title: String, cancel: String, object: NSArray,eventFlag: Int , target: bottomMenuViewDelegate){
        ...
        if(cancel != ""){
            ...
            cancelBtn.addTarget(self, action: "hideView", forControlEvents: .TouchUpInside)
        ...
        if(object.count > 0){
            ...
            for (var i=0; i < object.count; i++){
                ...
                objectBtn.addTarget(self, action: "buttonClicked:", forControlEvents: .TouchUpInside)
                objectBtn.tag = i //标示
        ...
        removeBtn.alpha = 0.5
        removeBtn.addTarget(self, action: "hideView", forControlEvents: .TouchUpInside)
