...
class MyTDCodeImageViewController: UIViewController {
    ...
    func addButtonClicked(){
        ...
        bottomMenu.showBottomMenu("", cancel: "取消", object: ["保存图片"], eventFlag: 0, target: self)
    }
    ...
    func setUpPic(){
        ...
        //生成二维码，存储
        let TDCodeImage = ChangeValue.createQRForString("http://weibo.com/micinyh/home?wvr=5", qrImage: userIcon)
